...
<body>
    ...
    <header class="header">
        <section class="flex">
            <a href="#home" class="logo"> <span>S</span>pareParts</a>
    ...
    <div class="user-account">
        <section>
            ...
            <div class="display-orders"><!-- <p>Parts 01 <span>( 20.00/- x 2 )</span></p> -->
                <?php
                $select_cart = $conn->prepare("SELECT * FROM `cart` WHERE user_id = ?");
                $select_cart->execute([$user_id]);
                if ($select_cart->rowCount() > 0) {
    ...
    <div class="my-orders">
        <section>
            ...
            <!--<div class="box">
                <p>placed on : <span>02/07/2023</span> </p>
                <p>name : <span>yash vavaliya</span> </p>
                <p>number : <span>1234567890</span></p>
                <p>address : <span>xyz, varachha, Surat - 395006</span></p>
                <p>payment method : <span>cash on delivery</span></p>
                <p>your orders : <span>Parts 01 (20.00/- x 2), Parts 02 (30.00/- x 3),Parts 03 (40.00/- x 4)</span></p>
                <p>total price : <span>500.00/-</span></p>
    ...
    <div class="shopping-cart">
        <section>
            ...
            <!--<div class="box">
                ...
                <img src="images/part-1.jpg" alt="">
                <div class="content">
                    <p>Parts 01 <span>( 20.00/- x 2 )</span></p>
                    <form action="" method="post">
    ...
    <section class="about" id="about">
        ...
        <div class="box-container">
            <div class="box">
                ...
                <h3>XYZBHAI</h3>
                <a href="#menu" class="btn">Contect</a>
            </div>
    ...
    <section class="order" id="order">
        ...
        <form action="" method="post">
            <div class="display-orders">
                <!--<p>Parts 01 <span>(20.00/- x 2)</span></p>
                <p>Parts 02 <span>(30.00/- x 3)</span></p>
                <p>Parts 03 <span>(40.00/- x 4)</span></p>
                <p>Parts 04 <span>(50.00/- x 5)</span></p>-->
            ...
            <div class="grand-total"> <h3>Total Price :</h3> <span><?= $grand_total; ?>/-</span></div>
    ...
    <section class="footer1">
        <div class="box-container">
            <div class="box">
                ...
                <h3>SpareParts</h3>
                <p>Welcome in <span>Embroidery World's</span></p>
                <div class="share">
            ...
            <div class="box">
                ...
                <a href="#" class="links"> <i class="fas fa-envelope"></i> Embroidery@gmail.com </a>
                <a href="#" class="links"> <i class="fas fa-map-market-alt"></i> Punagam, surat - 395006 </a>
            </div>
            ...
            <div class="box">
                ...
                <a href="#faq" class="links"> <i class="fas fa-arrow-right"></i> faq </a>
            </div>
        ...
        <div class="credit"> &copy; copyright @ <?= date('Y'); ?> Property Website. All Rights Reserved.
